...
#define DOMAIN_ID(t)STRUCT_REF(t,2216,int)
#define PHASE_DOMAIN_INDEX(t)STRUCT_REF(t,2220,int)
#define DOMAIN_N_DOMAINS(t)STRUCT_REF(t,2228,int)
#define DOMAIN_SUPER_DOMAIN(t)STRUCT_REF(t,2408,Domain *)
#define DOMAIN_SUB_DOMAIN(t,i)(STRUCT_OFF(t,2232,Domain *)[i])

#define THREAD_STORE(t,nv)(STRUCT_OFF(t,58920,struct store_struct *)[nv])
#define THREAD_STORAGE(t,nv)(STRUCT_OFF(t,864,void *)[nv])
...
#define THREAD_DOMAIN(t)STRUCT_REF(t,856,Domain *)
#define THREAD_HEAD(t)STRUCT_REF(t,0,Thread_Head *)
#define THREAD_MATERIAL(t)(STRUCT_REF(THREAD_HEAD(t),21072,Material *))
...
#define P_VF(p)STRUCT_REF(p,1288,real)
#define P_CF(p)STRUCT_REF(p,1292,real)
#define P_VFF(p)STRUCT_REF(p,1296,real)
#define P_DF(p)STRUCT_REF(p,1300,real)
...
#define P_EVAP_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4864,int)
#define P_DEVOL_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4868,int)
#define P_OXID_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4872,int)
#define P_PROD_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),4876,int)
#define P_LAWS(p,in)STRUCT_OFF(P_INJECTION(p),772,int)[in]
